...
#
# This adds a file in /etc/pam.d/ which can then be used by
# googleauthenticator::pam resources.
#
# Parameters:
...
# - *nullok*: make module optional (users without a ~/.google_authenticator file
#   will still be able to log in);
# - *secret*: optionally, specify the location of the secret file (you may use
#   ${HOME}, ${USER} and ~);
