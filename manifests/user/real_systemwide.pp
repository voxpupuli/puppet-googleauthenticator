# == Definition: googleauthenticator::user::real_systemwide
#
...
# Example usage:
#
#     googleauthenticator::user::real_systemwide {'root':
#       secret_key    => 'C6SSDFBBH6P76EDM',
#       scratch_codes => ['78905638', '14036415', '77983530',
#                         '22071921', '19861182'],
#     }
#
define googleauthenticator::user::real_systemwide(
  $secret_key,
  $ensure='present',
  $user=undef,
  $rate_limit='3 30',
  ...
  $secret_file = "/etc/google-authenticator/google_authentificator"
